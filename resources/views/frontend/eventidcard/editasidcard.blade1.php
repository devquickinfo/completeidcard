...
(function () {
    ...
    // =========================================================
    // PHOTO / LOGO / SIGNATURE UPLOAD (local preview only)
    // =========================================================

    function wireImageUpload(inputId, targetElId) {
    ...
    wireImageUpload('photoUpload', 'elPhoto');
    wireImageUpload('logoUpload', 'elLogo');
    wireImageUpload('signUpload', 'elSign');
...
document.getElementById('elPhoto').src = @json($designcard->layout['fields']['photo']['src'] ?? '');
document.getElementById('elLogo').src = @json($designcard->layout['fields']['logo']['src'] ?? '');
